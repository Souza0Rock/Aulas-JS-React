...
const botao = 'Ativo'
  ...
  return (
    <>
      {/* {existe && <>teste</>} renderização condicional
      {existe ? <>teste</> : <>teste2</>} condição ternária*/}
      <Head>
                  ...
                  <div className="form">
                    ...
                    {redeLimpar && (
                      ...
                      >
                        ...
                        <option value="silas">Silas Souza</option>
                    ...
                    >
                      ...
                      {qtdDomingoManha < qtdMAxima && (
                        <option value="noite">Sábado - 19hs</option>
                      )}
                    ...
                    >
                      ...
                      {qtdDomingoManha < qtdMAxima && (
                        <option value="manha">Terça - 19hs</option>
                      )}
                    ...
                    <div className="vagas">
                      ...
                      <span>
                        {existe ? <>Sábado 15:00hs - </> : <>Segunda 18hs</>}
                        {qtdDomingoManha >= qtdMAxima && (
                          <small className="red"> vagas encerradas</small>
                        )}
                        {qtdDomingoManha < qtdMAxima && (
                    ...
                    <br></br>
                    {botao === 'Ativo' ? <button onClick={salve}>Inscrever</button> : false}
